...
import com.rajen.Security.JwtAuthenticationEntryPoint;
import com.rajen.Security.JwtAuthenticationFilter;
...
//		http.csrf().disable().cors().disable().authorizeHttpRequests().anyRequest().authenticated().and().httpBasic();
//		return http.build();
